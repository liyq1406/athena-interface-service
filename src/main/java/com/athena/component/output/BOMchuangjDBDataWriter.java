...
public class BOMchuangjDBDataWriter extends DBOutputTxtSerivce {

	public BOMchuangjDBDataWriter(DataParserConfig dataParserConfig) {
		...
		int totalPage = getTotalPage(write.getUsercenter(), read.getSql(),read.getIsAllSet(),pageSize);
	  	try {
	        ...
	        for(int i=0;i<totalPage;i++){
		    	...
		    	/*********************************************************/
		    	TableElement.addAttribute("name", "BOM创建");
