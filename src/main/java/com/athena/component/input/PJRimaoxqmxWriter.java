 ...
 *
 */
public class PJRimaoxqmxWriter extends TxtWriterDBTask{
	private Date date= new Date();
	public PJRimaoxqmxWriter(DataParserConfig dataParserConfig, List<String> fieldList, List<String> updateFieldList, String fileName, List<Record> lineList) {
