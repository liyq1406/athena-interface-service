 ...
 *
 */
public class Ckx_shengcx_lingjDBDataWriter extends TxtInputDBSerivce{
	public  Date date=new Date();
	private String datasourceId = "";
	
	public Ckx_shengcx_lingjDBDataWriter(DataParserConfig dataParserConfig) {
	...
	public void before() {
		...
		try{
			...
			.execute("inPutddbh.updateckx_shengcx_lingj");
	...
	public void after() {		
		try{
			dataParserConfig.getBaseDao().getSdcDataSource(datasourceId)
			.execute("inPutddbh.deleteckx_shengcx_lingj");
		}catch(RuntimeException e){
