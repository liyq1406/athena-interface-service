 ...
 *
 */
public class AnxpyDBDataWriter extends TxtInputDBSerivce{
	private String datasourceId = "";
	public AnxpyDBDataWriter(DataParserConfig dataParserConfig) {
	...
	public void before() {
		try{//清空2天前的数据
			...
			.execute("inPutzbc.anxpytempDelete");
	...
	public void after() {
			try{				
				...
				if(!k.equals("0")||!k.equals(null) ){ 
					...
					//筛选用户中心和产线 如:多条产线
					List<Map<String,Object>> uchanxlist = dataParserConfig.getBaseDao().getSdcDataSource(datasourceId).select("inPutzbc.queryAnxpychx"); 										
