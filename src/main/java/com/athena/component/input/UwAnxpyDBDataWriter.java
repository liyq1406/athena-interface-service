 ...
 *
 */
public class UwAnxpyDBDataWriter extends TxtInputDBSerivce{
	public String datasourceId = "";
	public String usercenter = "'UW'";	
	public String inbh = "1891";
	
	public UwAnxpyDBDataWriter(DataParserConfig dataParserConfig) {
