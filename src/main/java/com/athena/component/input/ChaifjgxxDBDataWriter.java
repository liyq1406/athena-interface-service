 ...
 *
 */
public class ChaifjgxxDBDataWriter extends TxtInputDBSerivce{
	...
	/**
	 * 数据解析之前清空零件xqjs_anxmaoxq表数据，根据laiybs=1删除
	...
	public void before() {
		try{
			...
			.execute("inPutzbc.anxmaoxqBybsDelete",dataParserConfig.getUsercenter());
